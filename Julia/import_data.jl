...
# ╔═╡ 2bcfe6d0-0b4f-11ec-1a9c-41fde3b5c29e
begin
	using CSV
	using DataFrames
	using Agents
...
# ╔═╡ 6579834c-138c-42e4-ae77-5e63425c0cb7
csv_reader = CSV.read("..\\data\\sevrance\\survey_table.csv", DataFrame)

# ╔═╡ 4904a38c-cd02-4a89-88df-c3a21b952143
csv_reader[(csv_reader.occupation .== "N") .& (csv_reader.weekday .== 0), :]

# ╔═╡ 1d09f4b8-d3ba-4613-9f49-40957294b0e5
strcat("asdf","asdf")

# ╔═╡ 262bb935-93d4-4870-b5d5-e229be81c64c


# ╔═╡ b2779078-a017-43c1-b1c7-3fc3f901c773
